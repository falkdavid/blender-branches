...
void BKE_gpencil_stroke_outer_boundary(struct bGPdata *gpd, struct bGPDstroke *gps, uint method);
void BKE_gpencil_stroke_isect_self(struct bGPdata *gpd, struct bGPDstroke *gps);
